...
## Canonical Docs
- [`docs/onboarding.html`](docs/onboarding.html) — full workspace setup and first-run guide (Podman, Zellij, OpenCode, CLI, web dashboard)
...
layers/   = Nuxt layers for UI, shell, and room-dashboard composition
